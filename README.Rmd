...
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-brightgreen.svg)](https://github.com/<username>/<PROJECT NAME>/commits/master) 
[![minimal R version](https://img.shields.io/badge/R%3E%3D-3.0.3-brightgreen.svg)](https://cran.r-project.org/) 
[![Travis-CI Build Status](https://travis-ci.org/<username>/<PROJECT NAME>.png?branch=master)](https://travis-ci.org/<username>/<PROJECT NAME>) 
...
>  <LAST NAME>, <FIRST NAME>. "<PAPER TITLE>". *<JOURNAL TITLE>* <VOLUME>, no. <NUMBER> (<YEAR>): <PAGES>. doi: https://dx.doi.org/xxxxxx.
...
3. As a framework for a [reproducible research]() project. In that case a better alternative might be my [research-template](github.com/<username>/research-template), which provides a skeleton with some thoughts about the best use. There are several other (and probably better) attempts at this, including [rrrpkg](https://github.com/ropensci/rrrpkg), [projecttemplate](http://projecttemplate.net/), and [cboettig's template](https://github.com/cboettig/template).
...
Code: [MIT License](https://opensource.org/licenses/MIT), 2017, <Your Name>
